...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    loadData();
  }, [messages.common.galleryLoadError]);
  ...
  return (
    <>
      <Hero>
        ...
        <HeroDescription>
          {messages.home.heroDescription1}
        </HeroDescription>
        <HeroDescription>
          {messages.home.heroDescription2}
        </HeroDescription>
        ...
        <SocialContainer>
          <SocialLink
            ...
            aria-label={messages.header.xAriaLabel}
          >
          ...
          <GitHubLink
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label={messages.home.githubAriaLabel}
          >
      ...
      <GamesGrid>
        {galleryData?.games.map(game => {
          const title = getLocalizedGameTitle(game.id, game.title, locale);
          const description = getLocalizedGameDescription(game.id, game.description, locale);
